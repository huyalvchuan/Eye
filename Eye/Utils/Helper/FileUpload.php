<?php
  /** 
  	setOption用于设置文件上传的属性，文件的名称，通过随机数，加特定开头设置。
    本类的实例对象用于处理上传文件，可以上传一个文件，也可同时处理多个文件上传
  */
  class FileUpload {
    public  $path;          //上传文件保存的路径
    private $allowtype = array('ppt','doc','docx'); //设置限制上传文件的类型
    ...
    private function proRandName() {    
      ...
      return $this->prename.$fileName.'.'.$this->fileType; 
    }
